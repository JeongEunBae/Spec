...
public class Application {
    ...
    , ActApplyRepository actApplyRepository, ActApplyService actApplyService, SchedulesRepository schedulesRepository, SchedulesService schedulesService, NoticeRepository noticeRepository, NoticeService noticeService) {
        return (args) -> {
