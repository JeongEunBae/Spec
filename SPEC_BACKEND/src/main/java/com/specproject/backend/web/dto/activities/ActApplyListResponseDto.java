...
@Getter
public class ActApplyListResponseDto extends com.specproject.backend.web.dto.ResponseDto {
  ...
  public ActApplyListResponseDto(com.specproject.backend.domain.activities.ActApply entity) {
