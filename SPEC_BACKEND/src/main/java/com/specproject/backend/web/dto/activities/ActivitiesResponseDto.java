...
@Getter
public class ActivitiesResponseDto extends com.specproject.backend.web.dto.ResponseDto {
  private Long act_id;
  ...
  public ActivitiesResponseDto(com.specproject.backend.domain.activities.Activities entity) {
