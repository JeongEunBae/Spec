...
@Getter
public class CommentsResponseDto extends com.specproject.backend.web.dto.ResponseDto {
  ...
  public CommentsResponseDto(com.specproject.backend.domain.comments.Comments entity) {
