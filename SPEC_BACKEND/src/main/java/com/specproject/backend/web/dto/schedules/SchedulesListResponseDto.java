...
@Getter
public class SchedulesListResponseDto extends com.specproject.backend.web.dto.ResponseDto {
  ...
  public SchedulesListResponseDto(com.specproject.backend.domain.schedules.Schedules entity) {
