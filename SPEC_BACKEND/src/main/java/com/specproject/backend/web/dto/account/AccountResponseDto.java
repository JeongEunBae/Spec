...
@Getter
public class AccountResponseDto extends com.specproject.backend.web.dto.ResponseDto {
  ...
  public AccountResponseDto(com.specproject.backend.domain.account.Account entity) {
