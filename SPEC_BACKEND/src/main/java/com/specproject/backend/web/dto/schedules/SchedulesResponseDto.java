...
@Getter
public class SchedulesResponseDto extends com.specproject.backend.web.dto.ResponseDto {
  ...
  public SchedulesResponseDto(com.specproject.backend.domain.schedules.Schedules entity) {
