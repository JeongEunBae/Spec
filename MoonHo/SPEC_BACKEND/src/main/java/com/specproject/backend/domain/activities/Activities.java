...
public class Activities extends BaseEntity {
    ...
    @Column(name = "ORGANIZER_PLAN", nullable = false)
    private String organizerPlan;

    @Column(name = "ORGANIZER_MANAGE", nullable = false)
    ...
    @Column(name = "MANAGER", nullable = false) // 데이터 사이즈 조정, null 여부 설정
    ...
    @Builder
    private Activities(String actName, String organizerPlan, String organizerManage,
                       String tag, String startPeriod, String endPeriod, String contents,
                       int price, String poster, String file, String manager, String page, String phone_number, int maxPeople) {
